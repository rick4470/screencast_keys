...
class Screenkey(gtk.Window):
    ...
    def __init__(self, logger, nodetach):
        ...
        self.screen_width = gtk.gdk.screen_width() / 4 
        self.screen_height = gtk.gdk.screen_height() / 2 
    ...
    def set_xy_position(self, setting):
        ...
        if setting == POS_CENTER:
            self.move(0, self.screen_height / 2 + 500)
        if setting == POS_BOTTOM:
            self.move(0, self.screen_height - window_height)
        if setting == POS_LEFT:
            self.move(0, self.screen_height - window_height * 2 + 300)
